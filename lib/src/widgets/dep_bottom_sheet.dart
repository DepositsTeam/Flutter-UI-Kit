...
class DepBottomSheet extends StatefulWidget {
  ...
  /// [stickyHeader] is the header of DepBottomSheet.
  /// User can interact by swiping or tapping the [stickyHeader]
  final Widget? stickyHeader;

  /// [contentBody] is the body of DepBottomSheet.
  /// User can interact by swiping or tapping the [contentBody]
  final Widget contentBody;

  /// [stickyFooter] is the footer of DepBottomSheet.
  /// User can interact by swiping or tapping the [stickyFooter]
  final Widget? stickyFooter;

  /// [stickyFooterHeight] defines the height of DepBottomSheet's [stickyFooter].
  final double stickyFooterHeight;

  /// [stickyHeaderHeight] defines the height of DepBottomSheet's [stickyHeader].
  final double stickyHeaderHeight;

  /// [elevation] controls shadow below the DepBottomSheet material.
  ...
  /// [controller] used to control DepBottomSheet behavior like hide/show
  final DepBottomSheetController controller;

  /// Defines the drag animation duration of the DepBottomSheet
...
class DepBottomSheetController extends ValueNotifier<bool> {
  DepBottomSheetController() : super(false);

  /// Defines the height of the DepBottomSheet's contentBody
  double? _height;
