...
class DepLoader extends StatefulWidget {
  ...
  const DepLoader(
      ...
      this.type = DepLoaderType.android,
      this.loaderIconOne,
      this.loaderIconTwo,
  ...
  /// Type of DepColor or [Color] which defines the color of the first dot in only  circle or square type of loader
  final Color loaderColorOne;

  /// Type of DepColor or [Color] which defines the color of the second dot in only  circle or square type of loader
  final Color loaderColorTwo;

  /// Type of DepColor or [Color] which defines the color of the third dot in only  circle or square type of loader
  ...
  /// Type of [DepLoaderType] ie, android, ios, circle , square and custom
  ...
  /// type of [double] or [DepSize] ie, small , medium or large which is used
        ...
        child: type == DepLoaderType.custom
            ...
            : Container(
                ...
                decoration: BoxDecoration(
                    color: color,
                    shape: type == DepLoaderType.circle
                        ? BoxShape.circle
                        : BoxShape.rectangle),
              ),
      );
