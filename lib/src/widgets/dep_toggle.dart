...
class DepToggle extends StatefulWidget {
  ...
  /// Button type of [DepToggleType] i.e, android, ios, custom, sqaure
  final DepToggleType? type;
  ...
  Widget build(BuildContext context) => Stack(
        children: <Widget>[
          ...
          Positioned(
            top: 5,
            child: InkWell(
              borderRadius: widget.type == DepToggleType.square
                  ? const BorderRadius.all(Radius.circular(0))
                  : widget.borderRadius ??
                      const BorderRadius.all(Radius.circular(20)),
              onTap: onStatusChange,
              child: Container(
                width: widget.type == DepToggleType.ios ? 45 : 36,
                height: widget.type == DepToggleType.ios ? 25 : 15,
                ...
                child: Padding(
                  ...
                  child: isOn
                      ...
                      : Text(
                          widget.disabledText ??
                              (widget.type == DepToggleType.custom ? 'OFF' : ''),
          ...
          Positioned(
            top: widget.type == DepToggleType.ios ? 7.5 : 3,
            left: widget.type == DepToggleType.ios ? 2 : 0,
            child: InkWell(
              onTap: onStatusChange,
              child: SlideTransition(
                ...
                child: Container(
                  ...
                  width: 20,
                  decoration: BoxDecoration(
                    shape: widget.type == DepToggleType.square
                        ? BoxShape.rectangle
