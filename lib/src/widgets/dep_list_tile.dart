...
class DepListTile extends StatelessWidget {
  ...
  const DepListTile({
    ...
    this.listItemTextColor = gray700,
    this.enabled = true,
    this.onTap,
    this.onLongPress,
    this.selected = false,
  ...
  /// The DepListTile's background color. Can be given [Color] or [GFColors]
  final Color? color;

  /// type of [Widget] or [GFAvatar] used to create rounded user profile
  final Widget? avatar;

  /// The title to display inside the [DepListTile]. see [Text]
  final Widget? title;

  /// The subTitle to display inside the [DepListTile]. see [Text]
  final Widget? subTitle;

  /// The description to display inside the [DepListTile]. see [Text]
  final Widget? description;

  /// The icon to display inside the [DepListTile]. see [Icon]
  final Widget? icon;

  /// defines the margin of DepListTile
  final EdgeInsets margin;

  /// defines the padding of DepListTile
