...
class DepCard extends StatelessWidget {
  ...
  final DepPosition? titlePosition;
  ...
  /// The corners of this [DepCard] are rounded by this [BorderRadius].
  final BorderRadiusGeometry? borderRadius;

  /// A border to draw above the [DepCard].
  final Border? border;
  ...
  Widget build(BuildContext context) {
    ...
    final Widget cardChild = Padding(
      ...
      child: Column(
        children: <Widget>[
          titlePosition == DepPosition.start
              ? title ?? Container()
              : showImage != false
                  ? ClipRRect(
                      // ignore: avoid_as
